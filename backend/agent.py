...
def classify_domain(question: str) -> str:
    ...
    krecipe_keywords = ["김치찌개", "불고기", "비빔밥", "갈비찜", "잡채", "된장찌개", "떡볶이", "순두부찌개", "상추쌈", "해물파전", "김밥", "삼계탕", "된장국", "막걸리", "전", "우거지국", "스테이크", "오징어볶음", "고등어구이", "미역국", "볶음밥", "갈비탕", "나물반찬", "파전", "찜닭", "간장게장", "귀리죽", "흑미밥", "삼겹살", "양념치킨", "오랫동안 끓인 국물", "모듬회", "탕수육", "쉐이크", "파스타", "샐러드", "반찬가게", "드레싱", "즉석밥", "신김치", "요구르트", "잠발라야", "핫윙", "청국장", "김치전", "햄버거", "카레", "연어구이", "소고기국", "간장소스", "렌틸콩", "달걀찜", "리조또", "돈부리", "프렌치토스트", "라자냐", "카프레제", "스프링롤", "와플", "라떼", "티라미수", "치킨너겟", "김치말이국수", "샌드위치", "찐빵", "조건반사", "비트스프", "소스", "프리타타", "모짜렐라", "계란말이", "스무디", "포카리 스웨트", "완자탕", "미숫가루", "수박화채", "타코", "조리법", "차돌박이", "마늘빵", "도넛", "볶음면", "단호박죽", "볶음김치", "크로와상", "형제의 발자취", "미트볼", "스시", "소세지빵", "농심라면", "상다리휘어지는", "우동", "냉면", "칼국수", "육개장", "감자탕", "닭갈비", "부대찌개", "짜장면", "짬뽕", "돈까스"]
